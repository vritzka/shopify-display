...
void create_settings_menu(void)
{
    ...
    cont = create_text(section, LV_SYMBOL_SETTINGS, "Other", LV_MENU_ITEM_BUILDER_VARIANT_1);
...
void log_memory_info() {
	...
	ESP_LOGI(TAG, "LARGEST BLOCK: %d", heap_caps_get_largest_free_block(MALLOC_CAP_INTERNAL));	
}
